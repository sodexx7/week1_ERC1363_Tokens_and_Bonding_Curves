...
contract BancorFormula is IBancorFormula {
    ...
    function calculateCrossReserveReturn(
        ...
        return crossReserveTargetAmount(
            _sourceReserveBalance, _sourceReserveWeight, _targetReserveBalance, _targetReserveWeight, _amount
        );
    }
     ...
     * @dev deprecated, backward compatibility
     */
    function calculateFundCost(uint256 _supply, uint256 _reserveBalance, uint32 _reserveRatio, uint256 _amount)
        public
        view
        returns (uint256)
    {
     ...
     * @dev deprecated, backward compatibility
     */
    function calculateLiquidateReturn(uint256 _supply, uint256 _reserveBalance, uint32 _reserveRatio, uint256 _amount)
        public
        view
        returns (uint256)
    {
     ...
     * @dev deprecated, backward compatibility
     */
    function purchaseRate(uint256 _supply, uint256 _reserveBalance, uint32 _reserveWeight, uint256 _amount)
        public
        view
        returns (uint256)
    {
     ...
     * @dev deprecated, backward compatibility
     */
    function saleRate(uint256 _supply, uint256 _reserveBalance, uint32 _reserveWeight, uint256 _amount)
        public
        view
        returns (uint256)
    {
     ...
     * @dev deprecated, backward compatibility
     */
    function liquidateRate(uint256 _supply, uint256 _reserveBalance, uint32 _reserveRatio, uint256 _amount)
        public
        view
        returns (uint256)
    {
